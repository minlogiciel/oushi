<?php
include_once($DOC_PATH."/jiaoyu/jy_item_include.inc");
$JY_KONGZI_TITLE = "École chinoise et Classe Confucius";
$JY_SCHOOL_TITLE = "École chinoise";

$SCHEDULE_TABLE = array(
	array("Calendrier scolaire d'année ", "Calendrier scolaire d'année "),
	array("Plan d’emploi d'année ", "Plan d’emploi d'année ")
);
$SCHEDULE_TIMER = 0; 
$SCHEDULE_HUODONG = 1; 
